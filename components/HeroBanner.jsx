...
const HeroBanner = ({ heroBanner }) => {
  return (
    <div className="relative rounded-2xl w-full h-[500px] py-6 md:py-10 px-6 md:px-[100px] mt-16 md:mt-20 bg-primary-light leading-none group " >
        <div>
            ...
            <div>
                <Link href={`/product/${heroBanner.product}`} >
                    <button type="button" className="rounded-lg py-[10px] px-4 bg-secondary text-white hover:bg-bgLight hover:text-primary-dark transition-all hover:translate-x-2 hover:font-bold ml-6 sm:ml-12 md:ml-0 mt-10 sm:mt-6 md:mt-10 text-[22px] font-medium cursor-pointer z-20 duration-300 " >
